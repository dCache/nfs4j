...
public class NfsTestUtils {

    private final static Random RANDOM = new Random();
    private NfsTestUtils() { /* utility class */}

    public static NFS4Client createClient() throws UnknownHostException {
        return createClient( new NFSv4StateHandler());
    }

    public static NFS4Client createClient(NFSv4StateHandler stateHandler) throws UnknownHostException {
