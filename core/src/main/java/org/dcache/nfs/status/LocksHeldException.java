...
public class LocksHeldException extends ChimeraNFSException {
    ...
    public LocksHeldException() {
        super(NFSERR_LOCKS_HELD);
    }

    public LocksHeldException(String msg) {
        super(NFSERR_LOCKS_HELD, msg);
    }

    public LocksHeldException(String msg, Throwable cause) {
        super(NFSERR_LOCKS_HELD, msg, cause);
    }
}
