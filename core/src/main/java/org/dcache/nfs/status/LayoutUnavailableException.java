...
public class LayoutUnavailableException extends ChimeraNFSException {

    private static final long serialVersionUID = 136678352049463821L;

    public LayoutUnavailableException() {
        super(NFSERR_LAYOUTUNAVAILABLE);
    }
