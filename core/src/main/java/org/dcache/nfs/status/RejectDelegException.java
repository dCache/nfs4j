...
public class RejectDelegException extends ChimeraNFSException {
    ...
    public RejectDelegException() {
        super(NFSERR_REJECT_DELEG);
    }

    public RejectDelegException(String msg) {
        super(NFSERR_REJECT_DELEG, msg);
    }

    public RejectDelegException(String msg, Throwable cause) {
        super(NFSERR_REJECT_DELEG, msg, cause);
    }
}
