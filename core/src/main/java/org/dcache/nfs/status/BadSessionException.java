...
public class BadSessionException extends ChimeraNFSException {
    ...
    public BadSessionException() {
        super(NFSERR_BADSESSION);
    }

    public BadSessionException(String msg) {
        super(NFSERR_BADSESSION, msg);
    }

    public BadSessionException(String msg, Throwable cause) {
        super(NFSERR_BADSESSION, msg, cause);
    }
}
