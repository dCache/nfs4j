...
public class DeadSessionException extends ChimeraNFSException {
    ...
    public DeadSessionException() {
        super(NFSERR_DEADSESSION);
    }

    public DeadSessionException(String msg) {
        super(NFSERR_DEADSESSION, msg);
    }

    public DeadSessionException(String msg, Throwable cause) {
        super(NFSERR_DEADSESSION, msg, cause);
    }
}
