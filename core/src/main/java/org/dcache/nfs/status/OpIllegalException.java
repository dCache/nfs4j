...
public class OpIllegalException extends ChimeraNFSException {
    ...
    public OpIllegalException() {
        super(NFSERR_OP_ILLEGAL);
    }

    public OpIllegalException(String msg) {
        super(NFSERR_OP_ILLEGAL, msg);
    }

    public OpIllegalException(String msg, Throwable cause) {
        super(NFSERR_OP_ILLEGAL, msg, cause);
    }
}
