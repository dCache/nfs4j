...
public class OpenModeException extends ChimeraNFSException {
    ...
    public OpenModeException() {
        super(NFSERR_OPENMODE);
    }

    public OpenModeException(String msg) {
        super(NFSERR_OPENMODE, msg);
    }

    public OpenModeException(String msg, Throwable cause) {
        super(NFSERR_OPENMODE, msg, cause);
    }
}
