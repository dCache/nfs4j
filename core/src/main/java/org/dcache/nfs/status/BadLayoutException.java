...
public class BadLayoutException extends ChimeraNFSException {
    ...
    public BadLayoutException() {
        super(NFSERR_BADLAYOUT);
    }

    public BadLayoutException(String msg) {
        super(NFSERR_BADLAYOUT, msg);
    }

    public BadLayoutException(String msg, Throwable cause) {
        super(NFSERR_BADLAYOUT, msg, cause);
    }
}
