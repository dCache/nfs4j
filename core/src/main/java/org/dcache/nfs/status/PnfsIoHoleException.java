...
public class PnfsIoHoleException extends ChimeraNFSException {
    ...
    public PnfsIoHoleException() {
        super(NFSERR_PNFS_IO_HOLE);
    }

    public PnfsIoHoleException(String msg) {
        super(NFSERR_PNFS_IO_HOLE, msg);
    }

    public PnfsIoHoleException(String msg, Throwable cause) {
        super(NFSERR_PNFS_IO_HOLE, msg, cause);
    }
}
