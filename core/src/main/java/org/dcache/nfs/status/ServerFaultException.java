...
public class ServerFaultException extends ChimeraNFSException {
    ...
    public ServerFaultException() {
        super(NFSERR_SERVERFAULT);
    }

    public ServerFaultException(String msg) {
        super(NFSERR_SERVERFAULT, msg);
    }

    public ServerFaultException(String msg, Throwable cause) {
        super(NFSERR_SERVERFAULT, msg, cause);
    }
}
