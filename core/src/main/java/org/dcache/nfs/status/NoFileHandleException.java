...
public class NoFileHandleException extends ChimeraNFSException {
    ...
    public NoFileHandleException() {
        super(NFSERR_NOFILEHANDLE);
    }

    public NoFileHandleException(String msg) {
        super(NFSERR_NOFILEHANDLE, msg);
    }

    public NoFileHandleException(String msg, Throwable cause) {
        super(NFSERR_NOFILEHANDLE, msg, cause);
    }
}
