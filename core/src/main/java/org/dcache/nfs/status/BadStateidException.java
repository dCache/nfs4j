...
public class BadStateidException extends ChimeraNFSException {
    ...
    public BadStateidException() {
        super(NFSERR_BAD_STATEID);
    }

    public BadStateidException(String msg) {
        super(NFSERR_BAD_STATEID, msg);
    }

    public BadStateidException(String msg, Throwable cause) {
        super(NFSERR_BAD_STATEID, msg, cause);
    }
}
