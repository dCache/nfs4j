...
public class RestoreFhException extends ChimeraNFSException {
    ...
    public RestoreFhException() {
        super(NFSERR_RESTOREFH);
    }

    public RestoreFhException(String msg) {
        super(NFSERR_RESTOREFH, msg);
    }

    public RestoreFhException(String msg, Throwable cause) {
        super(NFSERR_RESTOREFH, msg, cause);
    }
}
