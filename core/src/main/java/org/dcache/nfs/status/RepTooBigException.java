...
public class RepTooBigException extends ChimeraNFSException {
    ...
    public RepTooBigException() {
        super(NFSERR_REP_TOO_BIG);
    }

    public RepTooBigException(String msg) {
        super(NFSERR_REP_TOO_BIG, msg);
    }

    public RepTooBigException(String msg, Throwable cause) {
        super(NFSERR_REP_TOO_BIG, msg, cause);
    }
}
