...
public class RecallConflictException extends ChimeraNFSException {
    ...
    public RecallConflictException() {
        super(NFSERR_RECALLCONFLICT);
    }

    public RecallConflictException(String msg) {
        super(NFSERR_RECALLCONFLICT, msg);
    }

    public RecallConflictException(String msg, Throwable cause) {
        super(NFSERR_RECALLCONFLICT, msg, cause);
    }
}
