...
public class SymlinkException extends ChimeraNFSException {
    ...
    public SymlinkException() {
        super(NFSERR_SYMLINK);
    }

    public SymlinkException(String msg) {
        super(NFSERR_SYMLINK, msg);
    }

    public SymlinkException(String msg, Throwable cause) {
        super(NFSERR_SYMLINK, msg, cause);
    }
}
