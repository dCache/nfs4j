...
public class LeaseMovedException extends ChimeraNFSException {
    ...
    public LeaseMovedException() {
        super(NFSERR_LEASE_MOVED);
    }

    public LeaseMovedException(String msg) {
        super(NFSERR_LEASE_MOVED, msg);
    }

    public LeaseMovedException(String msg, Throwable cause) {
        super(NFSERR_LEASE_MOVED, msg, cause);
    }
}
