...
public class ReturnConflictException extends ChimeraNFSException {
    ...
    public ReturnConflictException() {
        super(NFSERR_RETURNCONFLICT);
    }

    public ReturnConflictException(String msg) {
        super(NFSERR_RETURNCONFLICT, msg);
    }

    public ReturnConflictException(String msg, Throwable cause) {
        super(NFSERR_RETURNCONFLICT, msg, cause);
    }
}
