...
const NFS4_INT64_MAX            = 0x7fffffff;
const NFS4_UINT64_MAX           = 0xffffffff;
const NFS4_INT32_MAX            = 0x7fffffff;
const NFS4_UINT32_MAX           = 0xffffffff;

const NFS4_MAXFILELEN           = 0xffffffff;
const NFS4_MAXFILEOFF           = 0xfffffffe;
...
const RET4_DURATION_INFINITE    = 0xffffffff;
...
union secinfo4 switch (int flavor) {
 case RPCSEC_GSS:
...
union callback_sec_parms4 switch (int cb_secflavor) {
case AUTH_NONE:
        void;
case AUTH_SYS:
