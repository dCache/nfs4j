...
public class OperationDELEGPURGE extends AbstractNFSv4Operation {
	...
	OperationDELEGPURGE(FileSystemProvider fs, RpcCall call$, CompoundArgs fh, nfs_argop4 args, ExportFile exports) {
		super(fs, exports, call$, fh, args, nfs_opnum4.OP_DELEGPURGE);
	}
